...
public class Neck : MonoBehaviour
{
    ...
    public class Angles
    {
        ...
        public byte[] GetVector(Body skeleton)
        {
            ...
            var toBeComparedL = AngleSet.Where(x => x.AngleT == AngleType.NeckAngle).FirstOrDefault().AngleValue;
            var toBeComparedR = AngleSet.Where(x => x.AngleT == AngleType.NeckAngle).FirstOrDefault().AngleValue;
