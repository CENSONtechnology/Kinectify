...
public class Ankle : MonoBehaviour
{
    ...
    public class Angles
    {
        ...
        public byte[] GetVector(Body skeleton)
        {
            ...
            var toBeComparedL = AngleSet.Where(x => x.AngleT == AngleType.AnkleLeftAngle).FirstOrDefault().AngleValue;
            var toBeComparedR = AngleSet.Where(x => x.AngleT == AngleType.AnkleRightAngle).FirstOrDefault().AngleValue;
