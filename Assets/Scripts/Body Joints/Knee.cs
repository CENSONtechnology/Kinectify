...
public class Knee : MonoBehaviour
{
    ...
    public class Angles
    {
        ...
        public byte[] GetVector(Body skeleton)
        {
            ...
            var toBeComparedL = AngleSet.Where(x => x.AngleT == AngleType.KneeLeftAngle).FirstOrDefault().AngleValue;
            var toBeComparedR = AngleSet.Where(x => x.AngleT == AngleType.KneeRightAngle).FirstOrDefault().AngleValue;
