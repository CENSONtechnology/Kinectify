...
public class Spine : MonoBehaviour
{
    ...
    public class Angles
    {
        ...
        public byte[] GetVector(Body skeleton)
        {
            ...
            var toBeComparedL = AngleSet.Where(x => x.AngleT == AngleType.SpineAngle).FirstOrDefault().AngleValue;
            var toBeComparedR = AngleSet.Where(x => x.AngleT == AngleType.SpineAngle).FirstOrDefault().AngleValue;
