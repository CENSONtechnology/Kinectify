...
public class Wrist : MonoBehaviour
{
    ...
    public class Angles
    {
        ...
        public byte[] GetVector(Body skeleton)
        {
            ...
            var toBeComparedL = AngleSet.Where(x => x.AngleT == AngleType.WristLeftAngle).FirstOrDefault().AngleValue;
            var toBeComparedR = AngleSet.Where(x => x.AngleT == AngleType.WristRightAngle).FirstOrDefault().AngleValue;
