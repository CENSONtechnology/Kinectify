...
public class Joints_test : MonoBehaviour
{
    ...
    public class Angles
    {
        ...
        public byte[] GetVector(Body skeleton)
        {
            ...
            double ShoulderLeftAngle = AngleBetweenTwoVectors(ShoulderLeft - HipLeft, ShoulderLeft - ElbowLeft);
            ...
            double ShoulderRightAngle = AngleBetweenTwoVectors(ShoulderRight - HipRight, ShoulderRight - ElbowRight);
            ...
            var toBeComparedL = AngleSet.Where(x => x.AngleT == AngleType.ShoulderLeftAngle).FirstOrDefault().AngleValue;
            var toBeComparedR = AngleSet.Where(x => x.AngleT == AngleType.ShoulderRightAngle).FirstOrDefault().AngleValue;

            txtRhandAngle.text = toBeComparedR.ToString();
            txtLhandAngle.text = toBeComparedL.ToString();
            AngleSet.Clear();
            return new byte[1];
        }
    }
